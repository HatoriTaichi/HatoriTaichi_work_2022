...
public:
	...
	static LPDIRECT3DTEXTURE9 GetTexture(string type) { return m_pTexture[m_TexType[type]]; }	// テクスチャの取得
	static int GetTexNum(void) { return m_nTextureMax; }	// テクスチャ数の取得
	static string *GetPasName(void) { return &m_FilePas[0]; }	// 最初のパス配列のポインタの取得
